    ...
    <section className="intro-section">
      <div className="intro-container">
        <div className="intro-column">
          ...
          <p>
            Nosso objetivo é promover o debate, aprimorar o olhar fotográfico 
            e incentivar a troca contínua de conhecimento, valorizando 
        ...
        <div className="intro-column">
          ...
          <h2>Como Surgimos</h2>
          <p>
            O Fotoclube nasceu da visão de <strong>Adriano "Drico" Coelho</strong>, 
            junto a <strong>Gerson Fortes</strong>, <strong>Luiz Hirose</strong> e <strong>Devair Muchiutti</strong>. 
            O que era um grupo de WhatsApp para saídas e debates evoluiu.
          </p>
          <p>
