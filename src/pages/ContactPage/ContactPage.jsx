  ...
  return (
    <div className="contact-page-wrapper">
      ...
      <section className="contact-hero">
        <h1>Fale Conosco</h1>
        <p>
          Tem dúvidas sobre como se associar, sugestões de eventos ou quer apenas 
          bater um papo sobre fotografia? Estamos à disposição.
        </p>
      </section>
      ...
      <div className="contact-container">
        <div className="contact-info-column">
          ...
          <div className="contact-info-item">
            ...
            <div className="contact-details">
              <h3>Redes Sociais</h3>
              <a href="https://instagram.com/fotoclube_aracatuba" target="_blank" rel="noopener noreferrer">
                @fotoclube_aracatuba
              </a>
