...
import { FaHeart, FaShareAlt, FaMapMarkerAlt, FaChevronLeft, FaChevronRight, FaBookmark } from 'react-icons/fa';
          ...
          <div className="featured-event-carousel">
            ...
            <div className="featured-slide" style={{ backgroundImage: `url(${featuredEvent.image})` }}>
              <div className="featured-content">
                ...
                <span><FaMapMarkerAlt /> {featuredEvent.location}</span>
              </div>
            </div>
            <div className="featured-nav">
              <button className="arrow"><FaChevronLeft /></button>
              <div className="dots">
                <span className="dot active"></span><span className="dot"></span><span className="dot"></span><span className="dot"></span><span className="dot"></span><span className="dot"></span>
              </div>
              <button className="arrow"><FaChevronRight /></button>
            </div>
          </div>
        )}
